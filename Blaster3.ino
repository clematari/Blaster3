...
#define START_MARKER   1
#define TEAM_COUNT     4
#define START_TEAM     1
#define LIGHT_UP_LASERPOINTER 50
#define LIGHT_UP_LED 1
#define LIGHT_UP_LED_HIT 1000
...
#define RED    0x007700
#define YELLOW 0x337700
#define GREEN  0x770000
...
const Teams teams[] = {
  { 0x010000, "Daniel", BLUE },
  { 0x020000, "Simon", RED },
  { 0x030000, "Xandi", YELLOW },
  { 0x040000, "Clemens", GREEN }
};
  ...
  if (currentEnergy > 0) {
    if (receiver.GetResults(&decoder)) {
      ...
      hitByName = getTeamNameByCode(hitByCode);
          ...
          //Serial.print("hitByCode:");
          //Serial.println(hitByCode);
          //Serial.print("hitByColor:");
          //Serial.println(hitByColor);
          //Serial.print("hitByName:");
          //Serial.println(hitByName);
    
    
      if ((hitByCode != teams[currentTeam].code >> 16) && (lastHit != 0)){   //AND
